...
import torch
from player2 import SimpleRLPlayer, MaxDamagePlayer, TypedMaxPlayer
...
if __name__ == "__main__":
   ...
   #print(env_player.action_space_size())
    model = PPO.load(r"D:\XXZL\B3A\project\A\A2C\pattern\model_07081515\ppo_model_900000_steps.zip")
