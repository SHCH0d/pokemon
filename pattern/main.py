...
from player2 import SimpleRLPlayer, MaxDamagePlayer

if __name__ == "__main__":
    NB_TRAINING_STEPS = 2000_000
...
#    opponent = DUMPlayer()
    ...
    model = PPO(
        ...
        verbose=1,
        device="cpu",
        tensorboard_log=f"D:/XXZL/B3A/project/A/A2C/pattern/ppo_tensorboard_{num}/"
    )
    
    # ✅ 设置定期保存模型的 callback
    checkpoint_callback = CheckpointCallback(
        save_freq=SAVE_INTERVAL,
        save_path=f"D:/XXZL/B3A/project/A/A2C/pattern/model_{num}/",
    ...
    # ✅ 最终保存一次
    model.save(f"D:/XXZL/B3A/project/A/A2C/pattern/model_{num}/final_model")
